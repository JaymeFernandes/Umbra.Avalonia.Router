...
public class RouterHistory<TViewModelBase> : RouterHistoryBase<TViewModelBase, Control>
    where TViewModelBase : class, IRoutePage
{
    public RouterHistory(IServiceProvider serviceProvider, RouterConfig<TViewModelBase> config,
